...
export class ProductService{
  ...
  productlist: products[] = [
    ...
    { id: 2, name: 'E-procurement Software',title: 'e-procurement system is a single web portal from where and through which supplier is able to perform their procurement related activities using a dedicated secured web-based dashboard',image1url: 'assets/products/e-procure1.png',image2url:'assets/products/e-procure2.png',image3url:'assets/products/e-procure3.png',description:'' },
